...
extension DropFile {
    var hasIndexedSnapshot: Bool {
        indexedContentHash != nil && indexedAt != nil
    }

    var indexedSnapshotMatchesCurrentContent: Bool {
        guard let contentHash, let indexedContentHash, hasIndexedSnapshot else { return false }
        return contentHash == indexedContentHash
    }
